...
const FoodSearch: React.FC = () => {
  ...
  useEffect(() => {
    if (searchTerm) {
      setLoading(true);
      fetch(
        `https://world.openfoodfacts.org/cgi/search.pl?search_terms=${searchTerm}&json=1`
      )
      ...
      <Center>
        <Box width="100%" maxW="lg" boxShadow="lg" rounded="lg" p={6} mt={8}>
          <Heading
            ...
            size="xl"
            mb={4}
            color={colorMode === "light" ? "gray.700" : "teal.500"}
          >
          ...
          <Text
            ...
            mb={4}
          >
            Search for detailed information about medicines, nutrition, and food
            products.
          </Text>
          <Input
                              ...
                              <Table variant="striped" size="sm">
                                ...
                                <Tbody>
                                  ...
                                  <Tr>
                                    <Td>Energy (kJ)</Td>
                                    <Td>
                                      {getNutrientValue(product, "energy-kj") +
                                        " kJ" || "N/A"}
                                    </Td>
                                  </Tr>
                                  <Tr>
                                  ...
                                  <Tr>
                                    <Td>Sugars (g)</Td>
                                    <Td>
                                      {getNutrientValue(product, "sugars") ||
                                        "N/A"}
                                    </Td>
                                  </Tr>
                                  <Tr>
                                    <Td>Fiber (g)</Td>
                                    <Td>
                                      {getNutrientValue(product, "fiber") ||
                                        "N/A"}
                                    </Td>
                                  </Tr>
                                  <Tr>
                                    <Td>Proteins (g)</Td>
                                    <Td>
                                      {getNutrientValue(product, "proteins") ||
                                        "N/A"}
                                    </Td>
                                  </Tr>
                                  <Tr>
